...
// Creates a widget with font outline enabled (for better readability on 3D backgrounds)
template<typename T>
...
// Creates a widget with font outline enabled (overload without text parameter)
template<typename T>
...
// Creates a labeled field with a name label and a widget arranged horizontally
...
// Creates a labeled field with a name label and two widgets arranged horizontally
...
// Initializes the Vec3 editor widget with X, Y, Z input fields and spinboxes
...
// Sets the displayed value in all three input fields
...
// Returns the current value from all three input fields as a Vec3
...
// Initializes the Vec2 editor widget with X, Y input fields and spinboxes
...
// Sets the displayed value in both input fields
...
// Returns the current value from both input fields as a Vec2
...
// Initializes the bone selection panel with a tree view of all bones in the skeleton
...
// Returns the index of the currently selected bone in the tree view, or -1 if none
...
// Creates and configures the bone selection UI widgets (group box, scroll box, tree)
...
// Initializes the LookAt chain editor with the skinned mesh and bone selection reference
...
// Returns the ID of the currently selected LookAt chain, or -1 if none selected
...
// Creates all UI widgets for the LookAt chain editor (chains list, settings, bones list)
...
// Refreshes the list of LookAt chains in the UI
...
// Refreshes the list of bones in the currently selected chain
...
// Called when the selected chain changes - updates UI and visualization
...
// Called when the selected bone changes - updates bone settings and visualization
...
// Initializes the IK chain editor with the skinned mesh and bone selection reference
...
// Returns the ID of the currently selected IK chain, or -1 if none selected
...
// Creates all UI widgets for the IK chain editor (chains list, settings, bones list)
...
// Refreshes the list of IK chains in the UI
...
// Refreshes the list of bones in the currently selected IK chain
...
// Called when the selected IK chain changes - updates UI and visualization
...
// Called when the selected bone changes - updates bone visualization
...
// Initializes the constraint editor with the skinned mesh and bone selection reference
...
// Creates all UI widgets for the constraint editor (constraints list, settings)
...
// Refreshes the list of bone constraints in the UI
...
// Called when the selected constraint changes - updates UI and visualization
