...
// Custom widget for editing Vec3 values with three spin boxes (X, Y, Z)
...
// Custom widget for editing Vec2 values with two spin boxes (X, Y)
...
// Widget displaying the bone hierarchy as a tree, allowing bone selection.
// Selected bone is highlighted in the viewport visualization.
...
// Editor panel for creating and configuring LookAt chains.
// Allows adding/removing chains and bones, setting target/pole positions,
// and adjusting per-bone weights and axes.
...
// Editor panel for creating and configuring IK (Inverse Kinematics) chains.
// Provides controls for target/pole positions, effector rotation, solver iterations,
// tolerance, and constraint modes.
...
// Editor panel for creating and configuring bone rotation constraints.
// Allows setting rotation limits (min/max angles) for yaw, pitch, and roll axes
// on individual bones.
