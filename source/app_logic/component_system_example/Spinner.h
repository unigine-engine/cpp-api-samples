...
// Rotating obstacle that spawns projectiles at random intervals.
// Demonstrates material parameter animation (color cycling via HSV),
// runtime node cloning, and component property modification.
