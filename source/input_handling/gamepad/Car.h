...
// Simple vehicle controller using JointWheel physics for wheel simulation.
// Receives velocity, steering angle, and brake inputs from input handlers.
// Implements Ackermann steering geometry via carBase/carWidth parameters
// to calculate proper inner/outer wheel angles during turns.
