...
// for each connected joystick. FFB effects include constant force, spring,
// damper, friction, ramp, and periodic effects (sine, square, triangle, sawtooth).
// Each effect can be configured with magnitude, duration, and frequency parameters.
