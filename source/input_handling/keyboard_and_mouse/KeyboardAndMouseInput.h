...
// via unicode events, and monitors mouse position, delta movement, and wheel scrolling.
// Pressed states are tracked in HashSets to display all currently held inputs.
