// Shows microprofiler URL for browser-based performance analysis. Enables background
// rendering to allow profiling while the window is not focused.
...
// Microprofiler URL is displayed if available; background updates are enabled.
...
// Background update mode is restored and UI is closed.
