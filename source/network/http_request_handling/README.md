...
Additional response details can be viewed in the console output.
...
The **![github.com/yhirose/cpp-httplib](https://github.com/yhirose/cpp-httplib)** library is used to perform *HTTP* requests asynchronously.

The *JSON* response is processed using the *Json* Class and displayed in the sample *UI*.