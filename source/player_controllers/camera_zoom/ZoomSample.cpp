...
// GUI window with zoom slider and target buttons is created.
void ZoomSample::init()
{
	...
	// Slider callback updates zoom and refreshes all parameter labels
	...
	// Labels display current camera settings affected by zoom
	...
	// Target buttons allow quick camera orientation toward predefined objects
...
// Required components and nodes are validated.
