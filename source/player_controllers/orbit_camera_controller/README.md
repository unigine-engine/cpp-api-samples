...
The *CameraOrbitSample* component enables orbit-style camera movement around a target object using a *PlayerDummy* node and the *CameraControls* component to process configurable input controls for camera movement and zoom.
