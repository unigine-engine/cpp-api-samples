// Sample UI for configuring spectator camera parameters: mouse sensitivity,
// turning speed, base velocity, and sprint velocity. Also provides toggles
// for input control and collision detection.
...
// Gets SpectatorController reference, configures mouse mode, reads initial parameter
// values, and creates GUI with sliders and checkboxes for runtime adjustment.
...
// Restores original mouse mode and cleans up GUI.
