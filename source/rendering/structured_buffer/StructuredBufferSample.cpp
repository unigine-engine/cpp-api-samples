// GPU-based DXT1 texture compression using compute shaders and structured
// buffers. Demonstrates creating UAV structured buffer, dispatching compute
// shader, and async GPU->CPU transfer to save compressed image.
...
// Loads texture, dispatches compute shader for DXT compression, and saves result to file.
