...
It showcases the use of the **Mesh** class and **ObjectMeshDynamic** nodes to procedurally generate a variety of basic shapes (**Box, Sphere, Cylinder, Capsule, Prism with a custom number of sides** and **Plane**) via code.
