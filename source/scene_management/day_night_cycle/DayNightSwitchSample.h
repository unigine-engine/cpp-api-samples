...
// Sample controller for day/night cycle demonstration.
// Shows two switching methods: zenith angle threshold (sun position)
// and time-based control (morning/evening bounds).
// Provides UI sliders to adjust sun time, timescale, and switching parameters.
