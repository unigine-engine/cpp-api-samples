...
The sample contains the *PathTrajectorySaver* component that illustrates how to create your own path file, which is opened via the *WorldTransformPath* node.
